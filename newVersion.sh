...
(cd minds_resourcepack/ && zip -r "../MindsResources_v${1}_mc_${2}_rp.zip" pack.mcmeta pack.png assets)
(cd minds_advancements/ && zip -r "../MindsAdvancements_v${1}_mc_${2}_dp.zip" pack.mcmeta data)
